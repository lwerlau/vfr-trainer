      ...
      <div className="mx-auto w-full max-w-6xl">
        ...
        <section>
          <div className="max-w-3xl">
            <h2 className="text-3xl font-semibold tracking-normal text-amber-400">
              Training Scenarios
            </h2>
            <p className="mt-3 text-slate-300">
              Curated decision-making lessons covering common VFR-into-IMC
              accident patterns
            </p>
          </div>
        ...
        <section className="mt-14 border-t border-white/10 bg-slate-950/20 pt-10">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-slate-300">
                Custom scenarios generated by AI based on your selected
                parameters
              </p>
            </div>
          ...
          {generatedScenarios.length > 0 ? (
            ...
            <div className="mt-6 rounded-lg border border-dashed border-slate-700 bg-slate-900/50 p-8 text-center">
              <p className="text-slate-300">
                No generated scenarios yet. Click Generate New Scenario above to
                create one.
              </p>
            </div>
          )}
